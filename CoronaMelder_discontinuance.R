...
data_wave1$Beliefs_datasafety_5p <- car::recode(data_wave1$Beliefs_datasafetyn, '1=1; 2=2; 3=4; 4=5; 5=3') 

# From adoption paper analysis
...
data_wave2$Beliefs_datasafety_5p <- car::recode(data_wave2$Beliefs_datasafetyn, '1=1; 2=2; 3=4; 4=5; 5=3') 
...
data_wave3$Beliefs_datasafety_5p <- car::recode(data_wave3$Beliefs_datasafetyn, '1=1; 2=2; 3=4; 4=5; 5=3') 
...
data_wave4$Beliefs_datasafety_5p <- car::recode(data_wave4$Beliefs_datasafetyn, '1=1; 2=2; 3=4; 4=5; 5=3') 
...
data_wave5$Beliefs_datasafety_5p <- car::recode(data_wave5$Beliefs_datasafetyn, '1=1; 2=2; 3=4; 4=5; 5=3') 
...
data_wave6$Beliefs_datasafety_5p <- car::recode(data_wave6$Beliefs_datasafetyn, '1=1; 2=2; 3=4; 4=5; 5=3') 
...
status_all_overview %>% group_by(status, wave) %>% summarise(total = n() / 1900 * 100) %>% ggplot(aes(fill=status, y = total, x = wave)) + geom_bar(position="stack", stat="identity",width = 0.5) + 
  ylab('Percentage of the sample (n = 1900)') + xlab ('Wave') + scale_x_continuous(breaks = seq(1, 6, by = 1)) + scale_fill_discrete(name = 'Status', labels = c('Dropped out of study', 'Former user', 'Never used', 'Current user'), type=c('#4D4C4C', '#F8766D', '#9B9B9B', '#619CFF')) #+ scale_y_continuous(limits = c(0, 100), breaks = seq(0, 100, by = 20))
...
# From user in w1 to user in w2
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w1 to former user in w2
nrow(status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'user',])
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w1 to never used in w2 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w1 to stopped study in w2
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'user',]$nomem_encr,])

# From never used in w1 to user in w2
nrow(status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'never_used',])
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w1 to former user in w2
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w1 to never used in w2
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w1 to stopped study in w2
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From former user in w1 to user in w2
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w1 to former user in w2
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w1 to never used in w2 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w1 to stopped study in w2
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 1 & status_all_overview$status == 'former_user',]$nomem_encr,])


# From user in w2 to user in w3
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w2 to former user in w3
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'user',])
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w2 to never used in w3 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w2 to stopped study in w3
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'user',]$nomem_encr,])

# From never used in w2 to user in w3
nrow(status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'never_used',])
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w2 to former user in w3
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w2 to never used in w3
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w2 to stopped study in w3
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From former user in w2 to user in w3
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w2 to former user in w3
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w2 to never used in w3 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w1 to stopped study in w2
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 2 & status_all_overview$status == 'former_user',]$nomem_encr,])


# From user in w3 to user in w4
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w3 to former user in w4
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'user',])
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w3 to never used in w4 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w3 to stopped study in w4
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'user',]$nomem_encr,])

# From never used in w3 to user in w4
nrow(status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'never_used',])
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w3 to former user in w4
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w3 to never used in w4
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w3 to stopped study in w4
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From former user in w3 to user in w4
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w3 to former user in w4
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w3 to never used in w4 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w3 to stopped study in w4
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 3 & status_all_overview$status == 'former_user',]$nomem_encr,])


# From user in w4 to user in w5
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w4 to former user in w5
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'user',])
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w4 to never used in w5 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w4 to stopped study in w5
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'user',]$nomem_encr,])

# From never used in w4 to user in w5
nrow(status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'never_used',])
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w4 to former user in w5
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w4 to never used in w5
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w4 to stopped study in w5
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From former user in w4 to user in w5
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w4 to former user in w5
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w4 to never used in w5 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w4 to stopped study in w5
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 4 & status_all_overview$status == 'former_user',]$nomem_encr,])



# From user in w5 to user in w6
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w5 to former user in w6
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'user',])
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w5 to never used in w6 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'user',]$nomem_encr,])

# From user in w5 to stopped study in w6
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'user',]$nomem_encr,])

# From never used in w5 to user in w6
nrow(status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'never_used',])
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w5 to former user in w6
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w5 to never used in w6
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From never used in w5 to stopped study in w6
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'never_used',]$nomem_encr,])

# From former user in w5 to user in w6
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w5 to former user in w6
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'former_user' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w5 to never used in w6 (this should not happen)
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'never_used' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'former_user',]$nomem_encr,])

# From former user in w5 to stopped study in w6
nrow(status_all_overview[status_all_overview$wave == 6 & status_all_overview$status == 'dropout' & status_all_overview$nomem_encr %in% status_all_overview[status_all_overview$wave == 5 & status_all_overview$status == 'former_user',]$nomem_encr,])
...
#  geom_point() +
  ...
  geom_smooth(se=F) +
  ylab('Odds of someone discontinuing their use (%)') + xlab ('Months (1 = start use of CoronaMelder)') + scale_x_continuous(breaks = seq(1, 19, by = 5)) + ylim(0, 45)
...
attrition_curves.long %>%
  ...
  geom_line() +
  ylab('Number of remaining users (% of 762)') + xlab ('Months (1 = start use of CoronaMelder)') + scale_x_continuous(breaks = seq(1, 19, by = 1)) + scale_y_continuous(breaks = seq(0, 100, by = 10)) + ylim(0, 100) + scale_colour_discrete(name = '', labels = c('Use discontinuance', 'Discontinuance and drop-out'))


# Baseline model
Model_Baseline <- glm(formula = event ~ month,
                               family = binomial(link = "logit"),
                               data = data_complete)

Model_Baseline_poly <- glm(formula = event ~ poly(month, 4, raw=TRUE),
                                   family = binomial(link = "logit"),
                                   data = data_complete)


anova(Model_Baseline, Model_Baseline_poly, test ="Chisq")

summary(Model_Baseline)
summary(Model_Baseline_poly)

summ(Model_Baseline, exp = T) #exp = T means that we want exponentiated estimates
summ(Model_Baseline_poly, exp = T) #exp = T means that we want exponentiated estimates

Model_Baseline$aic
Model_Baseline_poly$aic
...
Model_Demographics <- glm(formula = event ~ poly(month, 4, raw=TRUE) + geslacht + lftdcat_re + oplcat_re,
                               family = binomial(link = "logit"),
                               data = data_complete)


summary(Model_Demographics)
summ(Model_Demographics, exp = T) #exp = T means that we want exponentiated estimates

anova(Model_Baseline_poly, Model_Demographics, test ="Chisq")
...
Model_UTAUT <- glm(formula = event ~ poly(month, 4, raw=TRUE) + PE_UTAUT + EE_UTAUT + FC_UTAUT + SI_UTAUT + geslacht + lftdcat_re + oplcat_re,
                        family = binomial(link = "logit"),
                        data = data_complete)

summary(Model_UTAUT)
summ(Model_UTAUT, exp = T)

anova(Model_Demographics, Model_UTAUT, test ="Chisq")
...
Model_HBM <- glm(formula = event ~ poly(month, 4, raw=TRUE) + PE_UTAUT + EE_UTAUT + FC_UTAUT + SI_UTAUT + HBM_PSus_self + HBM_PSev_self + HBM_selfefficacy_CoronaMelder + HBM_perceivedbenefits_CoronaMelder + HBM_barriers_CoronaMelder + geslacht + lftdcat_re + oplcat_re,
                      family = binomial(link = "logit"),
                      data = data_complete)

summary(Model_HBM)
summ(Model_HBM, exp = T) #exp = T means that we want exponentiated estimates

anova(Model_UTAUT, Model_HBM, test ="Chisq")
...
Model_Baseline_poly_tr <- glm(formula = event ~ poly(month, 4, raw=TRUE),
                           family = binomial(link = "logit"),
                           data = data_complete_train)


summary(Model_Baseline_poly_tr)
summ(Model_Baseline_poly_tr, exp = T)

Model_HBM_tr <- glm(formula = event ~ poly(month, 4, raw=TRUE) + PE_UTAUT + EE_UTAUT + FC_UTAUT + SI_UTAUT + HBM_PSus_self + HBM_PSev_self + HBM_selfefficacy_CoronaMelder + HBM_perceivedbenefits_CoronaMelder + HBM_barriers_CoronaMelder + geslacht + lftdcat_re + oplcat_re,
                 family = binomial(link = "logit"),
                 data = data_complete_train)

summary(Model_HBM_tr)
summ(Model_HBM_tr, exp = T)

Model_Context_tr <- glm(formula = event ~ poly(month, 4, raw=TRUE) + PE_UTAUT + EE_UTAUT + FC_UTAUT + SI_UTAUT + HBM_PSus_self + HBM_PSev_self + HBM_selfefficacy_CoronaMelder + HBM_perceivedbenefits_CoronaMelder + HBM_barriers_CoronaMelder + Beliefs_monitoring + Beliefs_Conspiracy + Beliefs_fearB + Beliefs_Society + Beliefs_datasafety_5p + HBM_PSus_other2 + HBM_PSev_other2 + Beliefs_technologyperformance_5p + Infectother + geslacht + lftdcat_re + oplcat_re,
                     family = binomial(link = "logit"),
                     data = data_complete_train)
...
#predicted hazards
Pred_Haz_Baseline <- predict(Model_Baseline_poly_tr, data_complete_test, type = "response")
Pred_Haz_HBM <- predict(Model_HBM_tr, data_complete_test, type = "response")
Pred_Haz_Context <- predict(Model_Context_tr, data_complete_test, type = "response")
...
Pred_Dev_HBM <- tibble(obs = Obs_Haz, pred = Pred_Haz_HBM) %>%
  mutate(dev = obs*log(pred) + (1-obs)*log(1-pred)) %>%
  summarise(deviance = -2*sum(dev))%>%
  pull(deviance)
...
Pred_Dev_Context <- tibble(obs = Obs_Haz, pred = Pred_Haz_Context) %>%
  mutate(dev = obs*log(pred) + (1-obs)*log(1-pred)) %>%
  summarise(deviance = -2*sum(dev))%>%
  pull(deviance)
...
# Drop-outanalysis
data_wave1_do <- data_wave1
data_wave6_do <- data_wave6

# Recode age categories into 17-34, 35-54, 55-64, 65-89 (cf. our previous paper)
data_wave1_do$lftdcat_re <- NA
data_wave1_do[data_wave1_do$lftdcat == '15 - 24 jaar', ]$lftdcat_re <- '17 - 34 jaar'
data_wave1_do[data_wave1_do$lftdcat == '25 - 34 jaar', ]$lftdcat_re <- '17 - 34 jaar'
data_wave1_do[data_wave1_do$lftdcat == '35 - 44 jaar', ]$lftdcat_re <- '35 - 54 jaar'
data_wave1_do[data_wave1_do$lftdcat == '45 - 54 jaar', ]$lftdcat_re <- '35 - 54 jaar'
data_wave1_do[data_wave1_do$lftdcat == '55 - 64 jaar', ]$lftdcat_re <- '55 - 64 jaar'
data_wave1_do[data_wave1_do$lftdcat == '65 jaar en ouder',]$lftdcat_re <- '65 - 89 jaar'


# Recode education level into low, medium, high (cf. our previous paper and Statistics Netherlands / CBS)
data_wave1_do$oplcat_re <- NA
data_wave1_do[is.na(data_wave1_do$oplcat),]$oplcat <- 'basisonderwijs'
data_wave1_do[data_wave1_do$oplcat == 'basisonderwijs', ]$oplcat_re <- 'low'
data_wave1_do[data_wave1_do$oplcat == 'vmbo', ]$oplcat_re <- 'low'
data_wave1_do[data_wave1_do$oplcat == 'havo/vwo', ]$oplcat_re <- 'middle'
data_wave1_do[data_wave1_do$oplcat == 'mbo', ]$oplcat_re <- 'middle'
data_wave1_do[data_wave1_do$oplcat == 'hbo', ]$oplcat_re <- 'high'
data_wave1_do[data_wave1_do$oplcat == 'wo', ]$oplcat_re <- 'high'


# Recode age categories into 17-34, 35-54, 55-64, 65-89 (cf. our previous paper)
data_wave6_do$lftdcat_re <- NA
data_wave6_do[data_wave6_do$lftdcat == '15 - 24 jaar', ]$lftdcat_re <- '17 - 34 jaar'
data_wave6_do[data_wave6_do$lftdcat == '25 - 34 jaar', ]$lftdcat_re <- '17 - 34 jaar'
data_wave6_do[data_wave6_do$lftdcat == '35 - 44 jaar', ]$lftdcat_re <- '35 - 54 jaar'
data_wave6_do[data_wave6_do$lftdcat == '45 - 54 jaar', ]$lftdcat_re <- '35 - 54 jaar'
data_wave6_do[data_wave6_do$lftdcat == '55 - 64 jaar', ]$lftdcat_re <- '55 - 64 jaar'
data_wave6_do[data_wave6_do$lftdcat == '65 jaar en ouder',]$lftdcat_re <- '65 - 89 jaar'

# Recode education level into low, medium, high (cf. our previous paper and Statistics Netherlands / CBS)
data_wave6_do$oplcat_re <- NA
data_wave6_do[is.na(data_wave6_do$oplcat),]$oplcat <- 'basisonderwijs'
data_wave6_do[data_wave6_do$oplcat == 'basisonderwijs', ]$oplcat_re <- 'low'
data_wave6_do[data_wave6_do$oplcat == 'vmbo', ]$oplcat_re <- 'low'
data_wave6_do[data_wave6_do$oplcat == 'havo/vwo', ]$oplcat_re <- 'middle'
data_wave6_do[data_wave6_do$oplcat == 'mbo', ]$oplcat_re <- 'middle'
data_wave6_do[data_wave6_do$oplcat == 'hbo', ]$oplcat_re <- 'high'
data_wave6_do[data_wave6_do$oplcat == 'wo', ]$oplcat_re <- 'high'

nrow(data_wave1_do[data_wave1_do$lftdcat_re == '17 - 34 jaar',]) / 1900
nrow(data_wave1_do[data_wave1_do$lftdcat_re == '35 - 54 jaar',]) / 1900
nrow(data_wave1_do[data_wave1_do$lftdcat_re == '55 - 64 jaar',]) / 1900
nrow(data_wave1_do[data_wave1_do$lftdcat_re == '65 - 89 jaar',]) / 1900

nrow(data_wave6_do[data_wave6_do$lftdcat_re == '17 - 34 jaar',]) / 1220
nrow(data_wave6_do[data_wave6_do$lftdcat_re == '35 - 54 jaar',]) / 1220
nrow(data_wave6_do[data_wave6_do$lftdcat_re == '55 - 64 jaar',]) / 1220
nrow(data_wave6_do[data_wave6_do$lftdcat_re == '65 - 89 jaar',]) / 1220

nrow(data_wave1_do[data_wave1_do$geslacht == 'Man',]) / 1900
nrow(data_wave1_do[data_wave1_do$geslacht == 'Vrouw',]) / 1900

nrow(data_wave6_do[data_wave6_do$geslacht == 'Man',]) / 1220
nrow(data_wave6_do[data_wave6_do$geslacht == 'Vrouw',]) / 1220

nrow(data_wave1_do[data_wave1_do$oplcat_re == 'low',]) / 1900
nrow(data_wave1_do[data_wave1_do$oplcat_re == 'middle',]) / 1900
nrow(data_wave1_do[data_wave1_do$oplcat_re == 'high',]) / 1900

nrow(data_wave6_do[data_wave6_do$oplcat_re == 'low',]) / 1220
nrow(data_wave6_do[data_wave6_do$oplcat_re == 'middle',]) / 1220
nrow(data_wave6_do[data_wave6_do$oplcat_re == 'high',]) / 1220


for (row in 1:nrow(data_wave6_do)) {
  data_wave6_do[row, "Behavior_UTAUT_w1"] <- data_wave1_do[data_wave1_do$nomem_encr == data_wave6_do[row, "nomem_encr"],]$Behavior_UTAUT
}

nrow(data_wave1_do[data_wave1_do$Behavior_UTAUT == "Ik gebruik de CoronaMelder app op dit moment",]) / 1900
nrow(data_wave1_do[data_wave1_do$Behavior_UTAUT == "Ik heb de CoronaMelder app in het verleden wel gebruikt maar op dit moment niet meer",]) / 1900
nrow(data_wave1_do[data_wave1_do$Behavior_UTAUT == "Ik heb de CoronaMelder app nooit gebruikt",]) / 1900

nrow(data_wave6_do[data_wave6_do$Behavior_UTAUT_w1 == "Ik gebruik de CoronaMelder app op dit moment",]) / 1220
nrow(data_wave6_do[data_wave6_do$Behavior_UTAUT_w1 == "Ik heb de CoronaMelder app in het verleden wel gebruikt maar op dit moment niet meer",]) / 1220
nrow(data_wave6_do[data_wave6_do$Behavior_UTAUT_w1 == "Ik heb de CoronaMelder app nooit gebruikt",]) / 1220

chisq_leeftijd.table = rbind(c(nrow(data_wave1_do[data_wave1_do$lftdcat_re == '17 - 34 jaar',]), nrow(data_wave1_do[data_wave1_do$lftdcat_re == '35 - 54 jaar',]), nrow(data_wave1_do[data_wave1_do$lftdcat_re == '55 - 64 jaar',]), nrow(data_wave1_do[data_wave1_do$lftdcat_re == '65 - 89 jaar',])), c(nrow(data_wave6_do[data_wave6_do$lftdcat_re == '17 - 34 jaar',]), nrow(data_wave6_do[data_wave6_do$lftdcat_re == '35 - 54 jaar',]), nrow(data_wave6_do[data_wave6_do$lftdcat_re == '55 - 64 jaar',]), nrow(data_wave6_do[data_wave6_do$lftdcat_re == '65 - 89 jaar',])))

chisq.test(chisq_leeftijd.table)


chisq_geslacht.table = rbind(c(nrow(data_wave1_do[data_wave1_do$geslacht == 'Man',]), nrow(data_wave1_do[data_wave1_do$geslacht == 'Vrouw',])), c(nrow(data_wave6_do[data_wave6_do$geslacht == 'Man',]), nrow(data_wave6_do[data_wave6_do$geslacht == 'Vrouw',])))

chisq.test(chisq_geslacht.table)


chisq_opl.table = rbind(c(nrow(data_wave1_do[data_wave1_do$oplcat_re == 'low',]), nrow(data_wave1_do[data_wave1_do$oplcat_re == 'middle',]), nrow(data_wave1_do[data_wave1_do$oplcat_re == 'high',])), c(nrow(data_wave6_do[data_wave6_do$oplcat_re == 'low',]), nrow(data_wave6_do[data_wave6_do$oplcat_re == 'middle',]), nrow(data_wave6_do[data_wave6_do$oplcat_re == 'high',])))

chisq.test(chisq_opl.table)

chisq_status.table = rbind(c(nrow(data_wave1_do[data_wave1_do$Behavior_UTAUT == "Ik gebruik de CoronaMelder app op dit moment",]), nrow(data_wave1_do[data_wave1_do$Behavior_UTAUT == "Ik heb de CoronaMelder app in het verleden wel gebruikt maar op dit moment niet meer",]), nrow(data_wave1_do[data_wave1_do$Behavior_UTAUT == "Ik heb de CoronaMelder app nooit gebruikt",])), c(nrow(data_wave6_do[data_wave6_do$Behavior_UTAUT_w1 == "Ik gebruik de CoronaMelder app op dit moment",]), nrow(data_wave6_do[data_wave6_do$Behavior_UTAUT_w1 == "Ik heb de CoronaMelder app in het verleden wel gebruikt maar op dit moment niet meer",]), nrow(data_wave6_do[data_wave6_do$Behavior_UTAUT_w1 == "Ik heb de CoronaMelder app nooit gebruikt",])))

chisq.test(chisq_status.table)
