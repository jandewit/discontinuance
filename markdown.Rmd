...
data_complete %>%
  ...
  geom_point() +
  geom_smooth() +
  ylab('Kans dat iemand stopt met gebruiken CoronaMelder (%)') + xlab ('Wave (1 = begin gebruik CoronaMelder)') + scale_x_continuous(breaks = seq(1, 6, by = 1)) + ylim(0, 100)
...
data_complete %>%
  ...
  geom_point() +
  geom_smooth(se=F) +
  ylab('Kans dat iemand stopt met gebruiken CoronaMelder') + xlab ('Maanden (1 = begin gebruik CoronaMelder)') + scale_x_continuous(breaks = seq(1, 19, by = 1))
