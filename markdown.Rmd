...
data_complete %>%
  ...
  geom_point() +
  geom_smooth() +
  ylab('Kans dat iemand stopt met gebruiken CoronaMelder') + xlab ('Wave (1 = begin gebruik CoronaMelder)') + scale_x_continuous(breaks = seq(1, 6, by = 1)) + ylim(0, 1)
...
data_complete %>%
  ...
  ylab('Kans dat iemand stopt met gebruiken CoronaMelder') + xlab ('Wave (1 = begin gebruik CoronaMelder)') + scale_x_continuous(breaks = seq(1, 6, by = 1)) + ylim(0, 1)#scale_y_continuous(breaks = seq(0, 1, by = 0.1))
